...
try{
 ...
 $longitude='';
 $timeZone='';
 $apikey='b348fac184bcbde5cf685700f05d4b8654fa4fd58fbacbcd7f2e3e6cf212247d';
  ...
  $json_array=json_decode($response,true);
	...
	function insert_into_database($statusCode,$statusMessage,$ipAddress,$countryCode,$countryName,$regionName,$cityName,$zipCode,$latitude,$longitude){
		...
		if($statusCode=='OK'){
			...
			mysqli_stmt_bind_param($stm,"ssssssssss",$statusCode,$ipAddress,$countryCode,$countryName,$regionName,$zipCode,$latitude,$longitude,$timeZone);
